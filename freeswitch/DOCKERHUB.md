...
| Tag | Description |
|---|---|
| `v0.1.0-rc.3` | aicc v0.1.0-rc.3, FreeSWITCH v1.11.3 |
...
docker run -d --name freeswitch --network host \
  ...
  rasonyang/freeswitch-aicc:v0.1.0-rc.3
...
```bash
VERSION=v0.1.0-rc.3 freeswitch/build.sh                              # both platforms, --push
VERSION=dev LOAD=1 PLATFORM=linux/arm64 freeswitch/build.sh          # one platform, into the local daemon
VERSION=v0.1.0-rc.3 MAKE_JOBS=3 freeswitch/build.sh                  # emulated builds want 2-3
