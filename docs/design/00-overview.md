...
Binds to: [phase1-decisions.md](../phase1-decisions.md). Reading order: 00 → 01 (telephony) → 02 (AI voice) → 03 (data) → 04 (API/SSE) → 05 (frontend) → 06 (capacity) → 07 (naming — mandatory for every layer).
